...
namespace nothinbutdotnetprep.specs
{
  public class MovieLibrarySpecs
  {
    ...
    public class when_sorting_movies : concern_for_searching_and_sorting
    {
      ...
      {
        var results = sut.all_movies().sortDescending(x => x.title);
      ...
      {
        var results = sut.all_movies().sort(x => x.title);
      ...
      {
        var results = sut.all_movies().sortDescending(x => x.date_published);
      ...
      {
        var results = sut.all_movies().sort(x => x.date_published);
